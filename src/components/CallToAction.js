        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pt-20">
          ...
          <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
            ...
            <p className="max-w-md text-xs font-thin tracking-wide text-gray-500 sm:text-sm sm:mx-auto">
              Your phonenumber will not be shared to anyone and shall only be used for the purposes
              of notifying you when our platform is ready. Cheers!
            </p>
          </div>
        </div>
      </div>
      <div className="relative px-4 sm:px-0 bg-teal-800">
        ...
        <div className="relative grid mx-auto overflow-hidden bg-white divide-y rounded shadow sm:divide-y-0 sm:divide-x sm:max-w-screen-sm sm:grid-cols-3 lg:max-w-screen-md">
          <div className="inline-block p-8 text-center">
            ...
            <p className="font-bold tracking-wide text-gray-800">Make it better</p>
          </div>
          <div className="inline-block p-8 text-center">
            <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-teal-100">
              <svg
            ...
            <p className="font-bold tracking-wide text-gray-800">Make it simple</p>
          </div>
          <div className="inline-block p-8 text-center">
            <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-teal-100">
              <svg
            ...
            <p className="font-bold tracking-wide text-gray-800">Keep it secure</p>
          </div>
        </div>
      </div>
    </div>
