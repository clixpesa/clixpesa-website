      ...
      <div className="max-w-xl mb-10 md:mx-auto text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative">Designed</span>
          </span>{' '}
          for everyday needs, while keeping it simple
        </h2>
        <p className="text-base text-gray-700 md:text-lg">
          We aim to deliver crypto products and solutions in
          a more familiar language and form for your everyday needs
        </p>
      </div>
      <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <p className="mb-3 text-sm text-gray-900">
              Send money and crypto directly from your mobile phone
              to your friends and family at a fraction of the current cost.
            </p>
          </div>
          <a
            href="/"
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <p className="mb-3 text-sm text-gray-900">
              Let your money and crypto work for you.
              Earn interest on your crypto and stablecoin deposits.
            </p>
          </div>
          <a
            href="/"
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <p className="mb-3 text-sm text-gray-900">
              A slice of heaven. Get notified on the best deals and offers
              and earn rewards on some of your purchases.
            </p>
          </div>
          <a
            href="/"
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Peer to peer loans</h6>
            <p className="mb-3 text-sm text-gray-900">
              Lend and borrow money from your peers on your own terms.
              Cycle your money and create a personal impact.
            </p>
          </div>
          <a
            href="/"
