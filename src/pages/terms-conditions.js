    ...
    <section class="bg-teal-50">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <div className="max-w-none text-gray-600 text-justify">
          <p>
            These terms and conditions outline the rules and regulations for the use of Clixpesa's
            Website, located at https://clixpesa.com/.
          </p>
          <p>
            By accessing this website we assume you accept these terms and conditions. Do not
            continue to use Clixpesa if you do not agree to take all of the terms and conditions
            stated on this page.
          </p>
          <p>
          ...
          <h3 className="text-2xl tracking-tight font-bold py-4">Cookies</h3>
          <p>
            We employ the use of cookies. By accessing Clixpesa, you agreed to use cookies in
            agreement with the Clixpesa's Privacy Policy.
          </p>
          <p>
          ...
          <h3 className="text-2xl tracking-tight font-bold py-4">License</h3>
          <p>
            Unless otherwise stated, Clixpesa and/or its licensors own the intellectual property
            rights for all material on Clixpesa. All intellectual property rights are reserved. You
            may access this from Clixpesa for your own personal use subjected to restrictions set in
          ...
          <ul className="list-disc pl-4 py-2">
            <li>Republish material from Clixpesa</li>
            <li>Sell, rent or sub-license material from Clixpesa</li>
            <li>Reproduce, duplicate or copy material from Clixpesa</li>
            <li>Redistribute content from Clixpesa</li>
          </ul>
          <p>
          ...
          <p>
            ...
            information in certain areas of the website. Clixpesa does not filter, edit, publish or
            review Comments prior to their presence on the website. Comments do not reflect the
            views and opinions of Clixpesa,its agents and/or affiliates. Comments reflect the views
            and opinions of the person who post their views and opinions. To the extent permitted by
            applicable laws, Clixpesa shall not be liable for the Comments or for any liability,
            damages or expenses caused and/or suffered as a result of any use of and/or posting of
            and/or appearance of the Comments on this website.
          </p>
          <p>
            Clixpesa reserves the right to monitor all Comments and to remove any Comments which can
          ...
          <p>
            You hereby grant Clixpesa a non-exclusive license to use, reproduce, edit and authorize
            others to use, reproduce and edit any of your Comments in any and all forms, formats or
            media.
          </p>
          <h3 className="text-2xl tracking-tight font-bold py-4">Hyperlinking to our Content</h3>
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Clixpesa; and (d) the link is in
          ...
          <p>
            ...
            linking to our website, you must inform us by sending an e-mail to Clixpesa. Please
          ...
          <p>
            No use of Clixpesa's logo or other artwork will be allowed for linking absent a
            trademark license agreement.
          </p>
          <h3 className="text-2xl tracking-tight font-bold py-4">iFrames</h3>
          <p>
          ...
          <h3 className="text-2xl tracking-tight font-bold py-4">Content Liability</h3>
          <p>
          ...
          <h3 className="text-2xl tracking-tight font-bold py-4">Reservation of Rights</h3>
          <p>
          ...
          <h3 className="text-2xl tracking-tight font-bold py-4">
          ...
          <h3 className="text-2xl tracking-tight font-bold py-4">Disclaimer</h3>
          <p>
